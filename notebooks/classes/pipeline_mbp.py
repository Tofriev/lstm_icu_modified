...
from classes.dataset_manager_mbp import DatasetManager_MBP
...
class Pipeline_MBP(object):
    ...
    def prepare_data(self):
        ...
        if (
            ...
            self.DataManager = DatasetManager_MBP(
...
class MultiDatasetPipeline(Pipeline_MBP):
